...
export const junoDocsSchema = z.object({
  topic: z.enum(Object.keys(TOPICS) as [TopicKey, ...TopicKey[]])
    .describe("Documentation topic to retrieve. Covers Juno concepts, SDK setup, CLI reference, configuration, and more.")
}).strict();
