...
export async function handleConfigApply(
  ...
  const args = buildConfigApplyArgs(params as { force?: boolean });
...
export async function handleCreateProject(
  ...
  try {
    ...
    const pm = params.packageManager as string;
...
export function registerConfigTools(server: McpServer): void {
  ...
  server.registerTool(
    ...
    async (params) => handleConfigApply(params as Record<string, unknown>)
  );
